...
cascada **TTY-TBX → TTY-Dew Point → MEGA**, en las cuencas Neuquina y Vaca
Muerta. Incluye un tablero Streamlit con corrida puntual, serie temporal, mapa
de la red, un sandbox de escenarios y un asistente para gente ajena al
proyecto.
...
|---|---|---|
| `README.md` (este) | cualquiera | qué es esto y dónde está cada cosa |
